...
int main ()
{
  ...
  **/
  ...
  PID pid_steer = PID();
  pid_steer.Init(0.3, 0.000093, 0.3, 1.2, -1.2); //0.3, 0.00009, 0.3
  PID pid_throttle = PID();
  pid_throttle.Init(0.2, 0.001, 0.07, 1.0, -1.0); //0.2, 0.001, 0.07
...
//           // Update the delta time with the previous command
          ...
          **/
          // The closest point of the current point has been figured out.
          int min_index = 0;
      	  for (int i = 0; i < x_points.size(); i++) {
          ...
          double yaw_goal = angle_between_points(x_position, y_position, x_points[min_index], y_points[min_index]);
          error_steer = yaw_goal - yaw;
...
//           // Update the delta time with the previous command
          ...
          **/
          ...
          double velocity_goal = v_points[min_index];
          error_throttle = velocity_goal - velocity;
